...
class PharmacyManagementSystem:
    ...
    def Update(self):
        conn = mysql.connector.connect(
            host='localhost', database='sys', username='root', passwd='qwertyuiopasdfgh')
    ...
    def fetch_data(self):
        conn = mysql.connector.connect(
            host="localhost", user="root", passwd="qwertyuiopasdfgh", database="sys")
        my_cursor = conn.cursor()
        my_cursor.execute("select * from pharma")
    ...
    def __init__(self, root):
        ...
        search_combo = ttk.Combobox(Buttonframe, width=12, font=(
            "arial", 17, "bold"), state='readonly',textvariable=self.search_type)
        ...
        txtsearch = Entry(Buttonframe, bd=3, relief=RIDGE,
                          width=12, font=("arial", 15, "bold"), textvariable=self.search_var)
        txtsearch.grid(row=0, column=7)

        btnsearchData = Button(Buttonframe, text="Search", width=12, font=(
            "arial", 15, 'bold'), bg="dark green", fg="white", command=self.searchData)
        btnsearchData.grid(row=0, column=8)
        btnshowData = Button(Buttonframe, text="Show All", width=12, font=(
            "arial", 15, 'bold'), bg="dark green", fg="white",command=self.fetch_datainfo)
        ...
        txtcomname = Entry(Dataframeleft, width=29, textvariable=self.company, font=(
        ...
        type_combo = ttk.Combobox(
            Dataframeleft, width=27, font=("arial", 10, "bold"), textvariable=self.type)
        ...
        med_combo = Entry(Dataframeleft, width=29, bd=3, relief=RIDGE, font=(
        ...
        txtlotnum = Entry(Dataframeleft, width=29, textvariable=self.lotNo, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        txtIssueDate = Entry(Dataframeleft, width=29, textvariable=self.id, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        lblExpDate = Label(Dataframeleft, text="Expiry Date :", font=(
            "arial", 15, "bold"), width=10, fg="black", padx=2)
        txtExpDate = Entry(Dataframeleft, width=29, textvariable=self.expiry, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        txtuses = Entry(Dataframeleft, width=29, textvariable=self.use, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        lblSideeffects = Label(Dataframeleft, text="Side Effects", font=(
            "arial", 15, "bold"), width=10, fg="black", padx=2)
        txtSideeffects = Entry(Dataframeleft, width=29, textvariable=self.se, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        lblDosage = Label(Dataframeleft, text="Dosage :", font=(
            "arial", 15, "bold"), width=12, fg="black", padx=2)
        txtDosage = Entry(Dataframeleft, width=29, textvariable=self.dose, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        lblprice = Label(Dataframeleft, text="Tablets Price :", font=(
            "arial", 15, "bold"), width=12, fg="black", padx=2)
        txtprice = Entry(Dataframeleft, width=29, textvariable=self.price, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        lblquantity = Label(Dataframeleft, text="Tablets Qty :", font=(
            "arial", 15, "bold"), width=12, fg="black", padx=2)
        txtquantity = Entry(Dataframeleft, width=29, textvariable=self.quantity, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        txtref1 = Entry(DataframeRight, width=29, textvariable=self.ref_var, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
        ...
        txtmed1 = Entry(DataframeRight, width=29, textvariable=self.addmed_var, font=(
            "arial", 10, "bold"), bd=3, relief=RIDGE)
